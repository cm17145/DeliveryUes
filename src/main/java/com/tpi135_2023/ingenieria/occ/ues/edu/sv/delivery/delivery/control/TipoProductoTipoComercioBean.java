 ...
 */
@RequestScoped
public class TipoProductoTipoComercioBean extends AbstractDataAccess<TipoProductoTipoComercio> {
    
    public TipoProductoTipoComercioBean() {
        super(TipoProductoTipoComercio.class);
    }
